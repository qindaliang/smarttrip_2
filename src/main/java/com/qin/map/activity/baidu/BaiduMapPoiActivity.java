...
public class BaiduMapPoiActivity extends Activity implements SensorEventListener, OnGetPoiSearchResultListener, INaviInfoCallback {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.et_baidumap_searchpoi:
                ...
                intent.setClass(BaiduMapPoiActivity.this, BaiduMapSearchPoiActivity.class);
