...
public class WashCarActivity extends AppCompatActivity implements OnGetPoiSearchResultListener, View.OnClickListener, OnRefreshLoadMoreListener, INaviInfoCallback {
...
//                        .poiUid(poiInfo.uid));
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ToastUtils.showBgResource(WashCarActivity.this, "抱歉，未找到结果");
        } else {
            StringBuilder sb = new StringBuilder(256);
            sb.append("\ngetAddress-------");
