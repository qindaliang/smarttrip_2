    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.startpoint:
                Intent sintent = new Intent(RestRouteShowActivity.this, StartAndEndPointActivity.class);
                ...
                break;
            case R.id.endpoint:
                Intent eintent = new Intent(RestRouteShowActivity.this, StartAndEndPointActivity.class);
